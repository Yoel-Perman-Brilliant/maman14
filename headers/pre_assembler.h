 ...
 * This pre-assemble, which takes in a file name without the .as extension and parses it into a new .am file with the
 * same name. If a .am file with this name already exists, deletes it and  creates a new file. If any errors are found,
 * the .am file is not created, but the program keeps analyzing the input file in order to find more errors.
