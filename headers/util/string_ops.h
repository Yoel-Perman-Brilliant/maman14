 ...
 * @param string the string that whether the character appears in it should be checked.
 * @param c the character that whether it appears in the string should be checked 
