...
object/pre_assembler.o: src/pre_assembler.c headers/pre_assembler.h headers/structures/hash_table.h \
						headers/util/string_ops.h headers/util/general_util.h headers/files.h
...
object/conversions.o: src/conversions.c headers/conversions.h
...
object/files.o: src/files.c headers/files.h
	gcc -c $(FlAGS) src/files.c -o object/files.o

object/requirements.o: src/requirements.c headers/requirements.h
